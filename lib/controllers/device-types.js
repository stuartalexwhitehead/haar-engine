...
// Update device type
router.put('/device-types/:deviceType', authorise('admin'));
router.put('/device-types/:deviceType', (req, res) => {
  DeviceTypeModel.findById(req.params.deviceType, (err, deviceType) => {
    if (err) {
      res.json({
        status: 'error',
...
// Delete device type
router.delete('/device-types/:deviceType', authorise('admin'));
router.delete('/device-types/:deviceType', (req, res) => {
